...
//Agora comentando os algoritmos de Ordenação


//Essa função pega a lista de numeros como parametro e atraves do selection sort realiza a ordenação dos elementos da lista em ordem crescente
...
//Essa função pega a lista de numeros como parametro e atraves do selection sort realiza a ordenação dos elementos da lista em ordem Decrescente
...
//Função que ordena strings atraves do selection sort em Ordem Crescente
...
// merge sort de numeros com a opção ordenar em ordem crescente ('c') ou decrescente ('d').
...
//Função para fracionar o vetor e conseguir realizar as comparações do Merge Sort
...
//Função para inserir Numeros aleatoriamente na lista
...
//Esvaziar a lista sem excluir ela
...
//função para preencher a lista de nomes a partir de um arquivo .txt
